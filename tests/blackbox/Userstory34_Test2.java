...
public class Userstory34_Test2 {
    ...
    @Test
    public void testUserstory34_Test2() throws Exception {
        driver.get(baseUrl + "/");
        ...
        driver.findElement(By.id("carType")).sendKeys("");
        driver.findElement(By.id("licensePlate")).clear();
        driver.findElement(By.id("licensePlate")).sendKeys("11-22-AA");
        driver.findElement(By.cssSelector("div.buttonBox > input[name=\"button\"]")).click();
        try {
