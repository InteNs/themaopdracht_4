...
public class Userstory4 {
    ...
    public void testUserStory4() throws Exception {
        ...
        try {
            assertEquals("Telefoonnummer", driver.findElement(By.xpath("//th[5]")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        ...
        driver.findElement(By.xpath("(//input[@name='button'])[14]")).click();
        try {
            assertEquals("Gebruiker Bewerken", driver.findElement(By.cssSelector("legend")).getText());
        } catch (Error e) {
            verificationErrors.append(e.toString());
        }
        driver.findElement(By.id("email")).clear();
        driver.findElement(By.id("email")).sendKeys("test1@hotmail.com");
        driver.findElement(By.id("emailrepeat")).clear();
        driver.findElement(By.id("emailrepeat")).sendKeys("test1@hotmail.com");
        driver.findElement(By.id("password")).clear();
        driver.findElement(By.id("password")).sendKeys("12345");
        driver.findElement(By.id("passwordrepeat")).clear();
        driver.findElement(By.id("passwordrepeat")).sendKeys("12345");
