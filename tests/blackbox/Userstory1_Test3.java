...
public class Userstory1_Test3 {
    ...
    @Test
    public void testUserStory1_Test3() throws Exception {
        driver.get(baseUrl + "/");
        ...
        driver.findElement(By.id("postalcode")).sendKeys("351aAA");
        driver.findElement(By.id("phonenumber")).clear();
        driver.findElement(By.id("phonenumber")).sendKeys("06123456ab");
