    ...
    <div class="buttonBoxLeft">
      ...
      <div class="p">
        ...
        <label class="formlabel" for="usertype">Type</label>
            ...
            <div class="buttonbox">
                <input type="hidden" value="${param.email}"/>
                <input type="hidden" value="${param.name}"/>
                <input type="hidden" value="${param.dateofbirth}"/>
                <input type="hidden" value="${param.address}"/>
                <input type="hidden" value="${param.postal}"/>
                <input type="hidden" value="${param.phonenumber}"/>
                <input type="hidden" value="${param.usertype}"/>
